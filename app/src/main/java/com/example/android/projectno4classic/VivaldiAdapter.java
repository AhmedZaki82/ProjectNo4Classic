...
public class VivaldiAdapter extends ArrayAdapter<Vivaldi> {

    public VivaldiAdapter(@NonNull Context context, @NonNull List<Vivaldi> vivaldis) {
        super(context, 0, vivaldis);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Vivaldi currentItem = getItem(position);
