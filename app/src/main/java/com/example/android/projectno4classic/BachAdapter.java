...
public class BachAdapter extends ArrayAdapter<Bach> {

    public BachAdapter(@NonNull Context context, @NonNull List<Bach> baches) {
        super(context, 0, baches);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Bach currentItem = getItem(position);
