...
public class SatieAdapter extends ArrayAdapter<Satie> {

    public SatieAdapter(@NonNull Context context, @NonNull List<Satie> saties) {
        super(context, 0, saties);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Satie currentItem = getItem(position);
