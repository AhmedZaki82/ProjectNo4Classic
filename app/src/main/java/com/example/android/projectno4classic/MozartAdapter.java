...
public class MozartAdapter extends ArrayAdapter<Mozart> {

    public MozartAdapter(@NonNull Context context, @NonNull List<Mozart> mozarts) {
        super(context, 0, mozarts);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Mozart currentItem = getItem(position);
